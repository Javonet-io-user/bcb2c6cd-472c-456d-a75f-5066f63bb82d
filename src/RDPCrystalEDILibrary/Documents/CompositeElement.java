...
import RDPCrystalEDILibrary.Documents.*;public abstract class CompositeElement {protected NObject javonetHandle; public CompositeElement(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
